...
import com.salesianostriana.dam.upload.files.storage.imgur.dto.GetImageResponse;
import com.salesianostriana.dam.upload.files.storage.imgur.dto.NewImageRequest;
import com.salesianostriana.dam.upload.files.storage.imgur.dto.NewImageResponse;
import com.salesianostriana.dam.upload.files.storage.imgur.error.ImgurBadRequestException;
import com.salesianostriana.dam.upload.files.storage.imgur.error.ImgurImageNotFoundException;
...
@Log
@Service
@ConditionalOnProperty(name = "storage.type", havingValue = "imgur")
